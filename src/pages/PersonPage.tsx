      ...
      { person && 
        <>
          <div className="person-page__block person-page__block_left">
            <Poster classname="poster" src={person.poster_path} title={person.name} ></Poster>
