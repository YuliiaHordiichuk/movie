...
class PersonDataClass {
  ...
  private transformPersonCreditsCastItem(movie: PersonCreditsCast) : PersonCreditsCast {
    return {
      ...movie,
  ...
  public getPersonDetails( id: string ) {
    return PersonApi.getPersonDetails(id).then(person => this.transformPersonData(person));
  }

  public getPersonMovieList(id : string ) {
    return PersonApi
      .getPersonCredits(id)
      .then(({cast}) => cast.map(this.transformPersonCreditsCastItem));
  }
}
